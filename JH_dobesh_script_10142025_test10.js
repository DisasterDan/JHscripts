...
if (
    ...
    if (mainBackground) {
        ...
        const swiperHTML = `
            <div class="banner-swiper" style="margin-top: calc((100% * (1012 / 1920)) - 150);margin-bottom: 60px;">
        ...
        function updateSwiperMargin() {
            ...
            const h = mainBackground.offsetHeight || 1012;
            const mt = Math.max(h, Math.max(0, calcHeight));
            const w = bannerSwiper.offsetWidth || window.innerWidth; 
            const calcHeight = (w * 1012 / 1920) - 150;
            bannerSwiper.style.setProperty('margin-top', `${mt}px`, 'important');
        }
...
document.addEventListener("DOMContentLoaded", function () { 
  /* navrácení do normálního stavu poté, co jsou načteny všechny prvky */
  const contentWrapper = document.querySelector("#content-wrapper");
  contentWrapper.style.setProperty('margin-top', '0', 'important');
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateMarginTop() {
        if (mainBackground && bannerSwiper) {
            ...
            bannerSwiper.style.setProperty('margin-top', `${mainBackgroundHeight}px`, 'important');
        }
    }
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function updateMarginTop() {
            if (header && contentWrapper) {
                ...
                contentWrapper.style.setProperty('margin-top', `${headerHeight}px`, 'important');
            }
        }
...
document.addEventListener("DOMContentLoaded", () => { 
    ...
    if (mainBackground && bannerSwiper) {
      ...
      bannerSwiper.style.setProperty('margin-top', `${backgroundHeight}px`, 'important');
    }
});
