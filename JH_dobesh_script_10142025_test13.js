...
if (
    ...
    if (mainBackground) {
        ...
        const swiperHTML = `
            <div class="banner-swiper" style="margin-top: calc(52.708333 * 100vw - 150px);margin-bottom: 60px;">
        ...
        function updateSwiperMargin() {
            ...
            // pro případ jiného ratia videa
            /*const h = mainBackground.offsetHeight || 0;
            bannerSwiper.style.marginTop = `${Math.max(h - 150, 0)}px`;*/
            bannerSwiper.style.setProperty('margin-top', 'calc(52.708333 * 100vw - 150px)', 'important');
        }
